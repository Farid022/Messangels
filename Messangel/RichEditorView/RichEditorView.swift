...
@objcMembers open class RichEditorView: UIView, UIScrollViewDelegate, WKNavigationDelegate, UIGestureRecognizerDelegate, ObservableObject {
    ...
    private func setup() {
        ...
        if let filePath = Bundle.main.url(forResource: "rich_editor", withExtension: "html") {
            DispatchQueue.main.async {
                self.webView.loadFileURL(filePath, allowingReadAccessTo: filePath.deletingLastPathComponent())
            }
        }
