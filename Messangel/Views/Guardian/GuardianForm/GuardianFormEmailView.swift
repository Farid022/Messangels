...
struct GuardianFormEmailView: View {
    @State private var progress = (100/6)*3.0
    ...
    var body: some View {
        GuardianFormBaseView(title: "Adresse mail" ,progress: $progress, valid: $valid, destination: AnyView(GuardianFormLegalAgeView(vm: vm))) {
