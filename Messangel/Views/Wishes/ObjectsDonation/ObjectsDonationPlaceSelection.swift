...
struct ObjectsDonationPlaceSelection: View {
    ...
    var body: some View {
        ZStack {
            FlowBaseView(menuTitle: "Objets", title: "À qui souhaitez vous donner \(vm.objectDonation.single_object! ? "cet objet?" : "ce groupe d’objets?")", valid: .constant(selectedDonation != .none), destination: selectedDonation == .organization ? AnyView(ObjectsDonationOrganization(vm: vm)) : AnyView(ObjectsDonationContact(vm: vm))) {
                HStack {
