...
struct FuneralPlaceSelection: View {
    ...
    var body: some View {
        ZStack {
            if showNote {
                NoteWithAttachementView(showNote: $showNote, note: $vm.location.bury_location_note.bound, attachements: $vm.attachements, noteAttachmentIds: $vm.location.bury_location_note_attachment)
                .zIndex(1.0)
