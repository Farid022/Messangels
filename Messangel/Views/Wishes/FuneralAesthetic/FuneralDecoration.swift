...
struct FuneralDecoration: View {
    ...
    var body: some View {
        FuneralNoteView(stepNumber: 2.0, totalSteps: 4.0, showNote: $showNote, note: $vm.asthetic.special_decoration_note, noteAttachmentIds: $vm.asthetic.special_decoration_note_attachment, oldAttachedFiles: $vm.asthetic.special_decoration_note_attachments, menuTitle: "Esthétique", title: "Indiquez si vous avez une demande particulière concernant la décoration", destination: AnyView(FuneralGuestsDress(vm: vm)), vm: vm)
    }
}
