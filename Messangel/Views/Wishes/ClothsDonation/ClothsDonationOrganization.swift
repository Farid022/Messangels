...
struct ClothsDonationOrganization: View {
    ...
    var body: some View {
        ZStack {
            FlowBaseView(menuTitle: "Vêtements et accessoires", title: "Sélectionnez un contact à qui donner *cet article *ces articles", valid: .constant(!selectedCompany.name.isEmpty), destination: AnyView(ClothsDonationPic(vm: vm))) {
