...
struct ClothsDonationContact: View {
    ...
    var body: some View {
        ZStack {
            ...
            FuneralChoiceBaseView(note: true, showNote: $showNote, menuTitle: "Vêtements et accessoires", title: "Sélectionnez un contact à qui donner *cet article *ces articles", valid: .constant(!selectedContacts.isEmpty), destination: AnyView(ClothsDonationPic())) {
