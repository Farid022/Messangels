...
struct ClothsDonationPic: View {
    ...
    var body: some View {
        ZStack {
            FlowBaseView(menuTitle: "Vêtements et accessoires", title: "\(vm.clothDonation.clothing_name) – Photo", valid: .constant(true), destination: AnyView(ClothsDonationNote(vm: vm))) {
