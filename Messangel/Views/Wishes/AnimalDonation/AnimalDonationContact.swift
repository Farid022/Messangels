...
//            }
            FlowBaseView(menuTitle: "ANIMAUX", title: "Sélectionnez un contact à qui confier *votre animal *vos animaux", valid: .constant(!selectedContact.first_name.isEmpty), destination: AnyView(AnimalDonationPic(vm: vm))) {
