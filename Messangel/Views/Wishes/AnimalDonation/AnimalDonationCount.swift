...
struct AnimalDonationCount: View {
    ...
    var body: some View {
        ZStack {
            ...
            FlowBaseView(noteText: $vm.animalDonation.single_animal_note.bound, note: true, showNote: $showNote, menuTitle: "ANIMAUX", title: "Souhaitez-vous ajouter un ou plusieurs animaux ?", valid: .constant(vm.animalDonation.single_animal != nil), destination: AnyView(AnimalDonationName(vm: vm))) {
                HStack {
